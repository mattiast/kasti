...
def get_episodes():
    ...
    arts = sess.xpath(
        "//article[contains(@class,'teaser') and not(contains(@class,'is-advertorial'))]"
    )
    ...
    datef = lambda a: a.xpath("a/div[@class='details']/span[@class='updated']/time")[
        0
    ].get_attr("data-formatted-date")
